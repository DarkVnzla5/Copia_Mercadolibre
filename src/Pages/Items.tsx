...
const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const resetForm = () => {
    setFormData({
      code: "", name: "", brand: "", category: "", description: "", price: "", quantity: "", imagesDisplay: "",
    });
    setImageFiles([]);
  };
      ...
      <div className="card-body p-6 gap-0">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="form-control">
              <label className="label font-medium text-sm text-base-content/70">Cantidad</label>
              <input
                type="number"
                name="quantity"
          ...
          <div className="form-control">
            <label className="label font-medium text-sm text-base-content/70">Descripción</label>
            <textarea
              name="description"
